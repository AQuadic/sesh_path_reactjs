            ...
            <div className="col-span-1">
              ...
              <div className="mt-3 grid space-y-3">
                ...
                <p>
                  ...
                  <span className="inline-block ms-1 text-xs bg-brandColor text-white py-1 px-2 rounded-lg">
                    We're hiring
                  </span>
                </p>
                <p>
            ...
            <div className="col-span-2">
              ...
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                  ...
                  <a
                    className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-brandColor text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                    href="#"
                  >
                    Subscribe
                  </a>
