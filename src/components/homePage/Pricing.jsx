        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="relative xl:w-10/12 xl:mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              <div>
                {/* Card */}
                <div className="p-4 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800">
                  ...
                  <div className="mt-5 grid sm:grid-cols-2 gap-y-2 py-4 first:pt-0 last:pb-0 sm:gap-x-6 sm:gap-y-0">
                    ...
                    <ul className="space-y-2 text-sm sm:text-base">
                      <li className="flex gap-x-3">
                        <span className="mt-0.5 size-5 flex justify-center items-center rounded-full bg-blue-50 text-brandColor dark:bg-blue-800/30 dark:text-blue-500">
                          <svg
                ...
                <div className="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border border-gray-200 rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800 dark:shadow-gray-900/20">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div className="flex justify-end">
                      <button
                        type="button"
                        className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-brandColor text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                      >
                        Start free trial
                      </button>
                    </div>
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
            ...
            <ul className="grid lg:grid-cols-6 lg:gap-6">
              ...
              <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-800">
                <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                  ...
                  <svg
                    className="shrink-0 size-5 text-brandColor dark:text-blue-500"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="hidden lg:block mt-6">
            ...
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-1">
                <a
                  className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-brandColor text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                  href="#"
                >
                  Get started
                </a>
